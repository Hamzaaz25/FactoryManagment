...
public class ManagerBaseFrame extends JFrame {
    String name;
    ...
    public ManagerBaseFrame(String name,String title){
        ...
        BackGround bg = new BackGround("./assets/soffaa.jpg");
        ...
        menuBar.setBackground(new Color(33, 47, 61));
